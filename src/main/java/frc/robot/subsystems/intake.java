...
public class intake extends SubsystemBase {
    // Motor declarations
    private CANSparkMax intkArriba = new CANSparkMax(5, MotorType.kBrushed);
    private CANSparkMax intkAbajo = new CANSparkMax(6, MotorType.kBrushed);  // Replace with the actual CAN ID for MotorArriba
    ...
    public void stopIntake() {
        intkArriba.set(0.001); // Activar en reversa
        intkAbajo.set(0.001); // Activar en reversa
